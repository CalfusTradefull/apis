...
export class CustomerController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all customers', description: 'Retrieves a list of all customers.' })
  getCustomers() {
  ...
  @Get(':customerid')
  @ApiOperation({ summary: 'Get customer by ID', description: 'Retrieves customer information based on the provided customer ID.' })
  ...
  @ApiOperation({ summary: 'Get customer address by ID', description: 'Retrieves customer address based on the provided customer ID.' })
  @ApiParam({ name: 'customerid', description: 'Customer ID' })
  ...
  @ApiBody({ type: CustomerDTO, description: 'Customer data to create a new customer' })
  ...
  @Put(':customerid')
  @ApiOperation({ summary: 'Update customer by ID', description: 'Updates customer information based on the provided customer ID.' })
  @ApiParam({ name: 'customerid', description: 'Customer ID' })
  ...
  @Delete(':customerid')
  @ApiOperation({ summary: 'Delete customer by ID', description: 'Deletes a customer based on the provided customer ID.' })
  @ApiParam({ name: 'customerid', description: 'Customer ID' })
